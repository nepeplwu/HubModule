...
class FaceDetector320(hub.Module):
    def _initialize(self):
        self.default_pretrained_model_path = os.path.join(
            self.directory, "ultra_light_fast_generic_face_detector_1mb_320")
        self._set_config()
    ...
    def run_cmd(self, argvs):
        ...
        self.parser = argparse.ArgumentParser(
            description=
            "Run the ultra_light_fast_generic_face_detector_1mb_320 module.",
            prog='hub run ultra_light_fast_generic_face_detector_1mb_320',
            usage='%(prog)s',
            add_help=True)
