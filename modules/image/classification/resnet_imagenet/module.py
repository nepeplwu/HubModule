...
from resnet_imagenet.resnet import ResNet, ResNetC5
from resnet_imagenet.processor import load_label_info
from resnet_imagenet.data_feed import test_reader
