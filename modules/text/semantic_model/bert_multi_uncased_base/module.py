...
from bert_multi_uncased_base.model.bert import BertConfig, BertModel


@moduleinfo(
    name="bert_multi_uncased_base",
    version="1.1.0",
    summary=
    "bert_multi_uncased_base, 12-layer, 768-hidden, 12-heads, 110M parameters ",
    author="google",
    author_email="",
    type="nlp/semantic_model",
)
class Bert(BERTModule):
