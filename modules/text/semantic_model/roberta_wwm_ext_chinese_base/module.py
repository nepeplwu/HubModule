...
from roberta_wwm_ext_chinese_base.model.bert import BertConfig, BertModel


@moduleinfo(
    name="roberta_wwm_ext_chinese_base",
    version="1.1.0",
    summary=
    "roberta_wwm_ext_chinese_base, 12-layer, 768-hidden, 12-heads, 110M parameters ",
    author="kinghuin",
