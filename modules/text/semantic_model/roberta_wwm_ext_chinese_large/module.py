...
from roberta_wwm_ext_chinese_large.model.bert import BertConfig, BertModel


@moduleinfo(
    name="roberta_wwm_ext_chinese_large",
    version="1.1.0",
    summary=
    "roberta_wwm_ext_chinese_large, 24-layer, 1024-hidden, 16-heads, 340M parameters ",
    author="kinghuin",
