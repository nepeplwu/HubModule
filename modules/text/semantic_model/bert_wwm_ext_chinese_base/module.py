...
from bert_wwm_ext_chinese_base.model.bert import BertConfig, BertModel


@moduleinfo(
    name="bert_wwm_ext_chinese_base",
    version="1.1.0",
    summary=
    "bert_wwm_ext_chinese_base, 12-layer, 768-hidden, 12-heads, 110M parameters ",
    author="kinghuin",
