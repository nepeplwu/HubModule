```shell
$ hub install bert_wwm_chinese_L-12_H-768_A-12==1.1.0
```
<p align="center">
...
# Load $ hub install bert_wwm_chinese_L-12_H-768_A-12 pretrained model
module = hub.Module(name="bert_wwm_chinese_L-12_H-768_A-12")
inputs, outputs, program = module.context(trainable=True, max_seq_len=128)

# Must feed all the tensor of bert_wwm_chinese_L-12_H-768_A-12's module need
