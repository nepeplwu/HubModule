```shell
$ hub install bert_uncased_large==1.1.0
```
<p align="center">
...
# Load $ hub install bert_uncased_large pretrained model
module = hub.Module(name="bert_uncased_large")
inputs, outputs, program = module.context(trainable=True, max_seq_len=128)

# Must feed all the tensor of bert_uncased_large's module need
