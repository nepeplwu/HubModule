...
from bert_wwm_ext_chinese_L_12_H_768_A_12.model.bert import BertConfig, BertModel


@moduleinfo(
    name="bert_wwm_ext_chinese_L-12_H-768_A-12",
    version="1.1.0",
    summary=
    "bert_wwm_ext_chinese_L-12_H-768_A-12, 12-layer, 768-hidden, 12-heads, 110M parameters ",
    author="kinghuin",
