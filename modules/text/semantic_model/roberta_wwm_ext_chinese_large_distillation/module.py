...
from roberta_wwm_ext_chinese_large_distillation.model.bert import BertConfig, BertModel


@moduleinfo(
    name="roberta_wwm_ext_chinese_large_distillation",
    version="1.1.0",
    summary=
    "roberta_wwm_ext_chinese_large_distillation, 3-layer, 1024-hidden, 16-heads, 61M parameters ",
    author="kinghuin",
