...
from roberta_wwm_ext_chinese_L_24_H_1024_A_16.model.bert import BertConfig, BertModel


@moduleinfo(
    name="roberta_wwm_ext_chinese_L-24_H-1024_A-16",
    version="1.1.0",
    summary=
    "roberta_wwm_ext_chinese_L-24_H-1024_A-16, 24-layer, 1024-hidden, 16-heads, 340M parameters ",
    author="kinghuin",
